...
{
    return (
        <button {...props} className={clsx("text-xl w-60 text-left p-3  max-md:text-3xl border border-white cursor-pointer transition-all duration-250 disabled:bg-shdn disabled:bg-none disabled:text-background",
