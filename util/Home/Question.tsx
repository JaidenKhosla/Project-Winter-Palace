...
export default function Question({ question, answer }: QuestionProps)
{
    ...
    return (
        <div className="w-150">
            <div onClick={()=>setToggle(toggle=>!toggle)} className={clsx("group p-3 border border-white w-full transition-all hover:bg-white hover:text-background justify-between flex items-center cursor-pointer", useToggle && "bg-white text-background")}>
